...
%     if ~iscolumn(T.(matlab.lang.makeValidName(tableVariable)))
...
%     end
    ...
    numCategories=numel(unique(T.(matlab.lang.makeValidName(tableVariable))));
    ...
    if numCategories<1000 % maximum of 99 categories for the variable splitting to be created
        
        tempCatVariable=T.(matlab.lang.makeUniqueStrings(tableVariable));
